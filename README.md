...
<head>
  ...
  <!-- SEO / Social -->
  <meta name="description" content="Marwa Qabeel — Data & AI projects, credentials, and contact." />
  <meta property="og:title" content="Marwa Qabeel — Data & AI" />
  <meta property="og:description" content="Selected projects, certificates, and portfolio." />
  ...
  <style>
    :root{
      --bg:#0b1220;--panel:#101a31;--panel-2:#0e162b;--text:#eaf0ff;--muted:#b6c1e2;
      --accent:#7aa2ff;--accent-2:#8ee2ff;--ring:rgba(122,162,255,.35);--ok:#47d17e;
    ...
    body{font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,"Helvetica Neue",Arial,sans-serif;
      background:linear-gradient(180deg,#0a1020 0%,#0c1425 60%,#0a0f20 100%);color:var(--text);-webkit-font-smoothing:antialiased}

    a{color:var(--accent);text-decoration:none} a:hover{text-decoration:underline}

    /* ===== Top navbar ===== */
    .topnav{position:sticky;top:0;z-index:50;backdrop-filter:saturate(140%) blur(10px);
      background:rgba(9,14,30,.55);border-bottom:1px solid rgba(255,255,255,.08);
      display:flex;align-items:center;justify-content:space-between;padding:10px 16px}
    .topnav .brand{font-weight:800;letter-spacing:.5px;color:var(--text)}
    ...
    .hero{min-height:100vh;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;
      background:radial-gradient(1200px 1200px at 50% -10%,rgba(138,167,255,.08),transparent 60%)}
    .hero .rings{position:absolute;inset:-10% -10% auto -10%;pointer-events:none;opacity:.7}
    .hero .rings span{position:absolute;border:1px solid rgba(255,255,255,.16);border-radius:50%;
    ...
    .btn{display:inline-flex;align-items:center;gap:8px;font-weight:600;background:linear-gradient(180deg,rgba(122,162,255,.22),rgba(122,162,255,.12));
      border:1px solid rgba(122,162,255,.45);padding:10px 12px;border-radius:12px;color:var(--text)}
    ...
    .scroll-indicator{position:absolute;bottom:22px;left:50%;transform:translateX(-50%);width:36px;height:36px;border-radius:999px;
    ...
    header .title h2{font-size:28px;line-height:1.15;margin:0}
    .section{margin-top:28px} .section h2{font-size:20px;margin:0 0 14px}
    .grid{display:grid;grid-template-columns:repeat(12,1fr);gap:14px}
    .card{grid-column:span 12;background:linear-gradient(180deg,var(--panel),var(--panel-2));border:1px solid rgba(255,255,255,.06);
    ...
    .list li{display:flex;justify-content:space-between;align-items:center;gap:12px;background:rgba(255,255,255,.03);
      border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:10px 12px}
    .course{font-weight:600}
    .badge{font-size:12px;font-weight:700;color:#06230f;background:linear-gradient(180deg,#6cf3a2,#38d878);
...
<body class="cats-off">
  ...
  <section class="hero" id="intro">
    ...
    <div class="content">
      ...
      <p class="sub">Georgia Tech OMSCS (’26). Udacity Mentor. I build practical AI systems and clear data stories.</p>
  ...
  <div class="wrap" id="main">
    ...
    <section id="about" class="section">
      <h2>About</h2>
      <p>Data & AI practitioner. Georgia Tech OMSCS (’26). Udacity Mentor. I design end-to-end ML solutions and communicate results clearly.</p>
    </section>
    ...
    <section id="skills" class="section">
      <h2>Skills</h2>
      <ul class="list">
        <li><span class="course">ML/NLP</span><span class="badge">BERT · GPT-2 · PyTorch</span></li>
        <li><span class="course">Analytics</span><span class="badge">Python · pandas · SQL · Tableau</span></li>
        <li><span class="course">Cloud/BI</span><span class="badge">AWS QuickSight · Amazon Q</span></li>
      </ul>
    </section>
    ...
    <section id="experience" class="section">
      <h2>Experience</h2>
      <p>Udacity Mentor — Data Analyst Essentials / DECI cohorts. Project guidance, debugging, cohort enablement.</p>
    </section>

    <!-- Projects (your existing cards) -->
      ...
      <div class="grid">
        <article class="card card--third">
          ...
          <div class="body">
            ...
            <ul class="bullets"><li>Configured Q, authored topics and Q Bar queries, and built an executive KPI dashboard.</li><li>Iteratively refined natural-language responses using user feedback for concise insights.</li></ul>
          </div>
        </article>
        ...
        <article class="card card--third">
          ...
          <div class="body">
            ...
            <ul class="bullets"><li>Trained adversarial models that improved equity by ~15% without measurable accuracy loss.</li><li>Engineered features and tracked parity/EO metrics to optimize allocations across demographics.</li></ul>
          </div>
        </article>
        ...
        <article class="card card--third">
          ...
          <div class="body">
            ...
            <ul class="bullets"><li>Benchmarked RNN/LSTM vs. transformer baselines; achieved ~99.5% test accuracy.</li><li>Released code and report for reproducibility.</li></ul>
        ...
        <article class="card card--third">
          ...
          <div class="body">
            ...
            <ul class="bullets"><li>Modeled regional mental-health trends from tweets; analyzed seasonality and geography.</li><li>Built Tableau visuals for stakeholder interpretation.</li></ul>
        ...
        <article class="card card--third">
          ...
          <div class="body">
            ...
            <ul class="bullets"><li>Built a CNN-based detector on ChestX-ray8 with localization to aid clinical review.</li></ul>
    ...
    <!-- Certificates (your existing content) -->
    <section id="certificates" class="section">
      ...
      <div class="grid">
        ...
        <article class="card card--half">
          <div class="hd">
            <div><div class="name">Data Structures and Algorithms Specialization</div><div class="org">University of California, San Diego</div></div>
            <a class="btn" href="https://coursera.org/share/3d915db4303a0b4b5b54d313df7f2eb4" target="_blank" rel="noopener" aria-label="View specialization certificate">Certificate</a>
          </div>
          <div class="body">
            <ul class="list">
        ...
        <!-- Coursera Discrete Math -->
        <article class="card card--half">
          <div class="hd">
            <div><div class="name">Introduction to Discrete Mathematics for Computer Science</div><div class="org">University of California, San Diego</div></div>
            <a class="btn" href="https://coursera.org/share/576f499c1ff93fa479f077e604ac1e2b" target="_blank" rel="noopener" aria-label="View specialization certificate">Certificate</a>
          </div>
          <div class="body">
            <ul class="list">
  ...
  <!-- JS: typewriter, nav toggle, active link, cat toggle, date -->
  <script>
    // Typewriter
    (function(){
    ...
    const ids=['about','skills','experience','projects','certificates'];
